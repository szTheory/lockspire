...
|-------|------|------|--------------|
| 111 | Demo URL Contract & Config Unification | Make `LOCKSPIRE_DEMO_BASE_URL` the single browser-visible URL truth for endpoint URL generation, Lockspire issuer, seeded redirects, smoke proof, and Docker bind behavior. | URL-01..05 |
