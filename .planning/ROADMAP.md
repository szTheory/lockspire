...
- [ ] 98-01-PLAN.md — D-01 opaque-token structural rejection at the front-edge of `verify_token/3` with a structured error map; new opaque-token fixture and seven shape-rejection assertions (VERIFIER-01).
...
| 98. Plug Hardening | 0/4 | Not started | - |
