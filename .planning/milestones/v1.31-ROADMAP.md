...
v1.31 systematically strengthened the Lockspire admin/operator design system across source-derived inventory, internal lab fixtures, shared primitives, highest-drift page IA/copy, browser proof, deterministic regression guardrails, bounded operator docs, and final adversarial review. It preserved OAuth/OIDC protocol behavior, storage schemas, host-owned operator authentication, the embedded-library shape, and the supported admin router boundary.
