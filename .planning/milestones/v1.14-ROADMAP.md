...
- [ ] **Phase 54: Resource Indicators (RFC 8707)** - Implement targeted audience (`aud`) claims and resource parameter validation.
...
|-------|----------------|--------|-----------|
| 54. Resource Indicators | 0/1 | Not started | - |
| 55. RAR Protocol Intake | 0/1 | Not started | - |
