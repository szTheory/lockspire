...
| Recurring meta-components | `page_hero`, `pane`, `entity_header`, `workflow_shell`, `section_card`, `metric_grid`, `task_card`, `filter_bar`, `action_bar`, `description_list`, `summary_stat`, `resource_list`, `resource_item`, `dense_resource_row`, `lifecycle_row`, `responsive_table`, `action_group`, `badge_group`, `status_cluster`, `confirmation_panel`, `empty_state`, `long_value`, `copy_once_secret_panel`, `policy_nav` | Overview, DCR, policies, keys, clients, support, tokens, consents, interactions, device authorizations, and logout deliveries. |
