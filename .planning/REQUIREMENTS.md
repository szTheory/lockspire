...
- [ ] **MIGRATE-02**: A `mix lockspire.doctor token_format` task (or extension of the existing doctor task) reports per-client format choices and flags any client where the inherited default has changed semantics. Diagnostic, not enforcement.
