...
## [1.0.0](https://github.com/szTheory/lockspire/compare/lockspire-v1.0.0...lockspire-v1.0.0) (2026-05-09)


### Features

* **27-01:** implement DCR JSON serialization ([673b78d](https://github.com/szTheory/lockspire/commit/673b78df3776d6f072cdb01156a898b616133517))
* **27-02:** implement RegistrationController and Tests ([d7ee025](https://github.com/szTheory/lockspire/commit/d7ee0253656f0e4a575cde3dcb0349ebb3df3a20))
* **27-02:** mount DCR endpoints in Router ([548c6e4](https://github.com/szTheory/lockspire/commit/548c6e4caecfd55b118c98ac0c952d50c9a7c41a))
* **28-01:** build and mount DCR policy LiveView ([2d08d7e](https://github.com/szTheory/lockspire/commit/2d08d7eadb3ecaf2a0982bc2842953275b687ccb))
* **28-01:** create DCR policy form schema ([83abed0](https://github.com/szTheory/lockspire/commit/83abed0ea47b8041f394e74c8711674b277fc23b))
* **28-02:** add admin initial access tokens core logic ([cdacecb](https://github.com/szTheory/lockspire/commit/cdacecb1fd67f5837fad6dca9b655c97589dbf31))
* **28-02:** build IAT index and new liveviews ([e3f17e7](https://github.com/szTheory/lockspire/commit/e3f17e780b517241884f9edf2bb00d6cd82aafa2))
* **28-03:** add provenance filter to clients index ([e3a8233](https://github.com/szTheory/lockspire/commit/e3a8233960f0167379ca8052179c0731565572a2))
* **28-03:** add self-registered panel and RAT rotate modal ([42f7392](https://github.com/szTheory/lockspire/commit/42f739268f7209512553f84d1c6da4bd12a4012d))
* **28-04:** Complete Phase 28 Plan 04: DCR and IAT Lifecycle Telemetry ([4e4a92e](https://github.com/szTheory/lockspire/commit/4e4a92e7d78c07ec266bea1be75db86cb89a45c4))
* **29-01:** truth-based registration endpoint discovery ([e61a1d1](https://github.com/szTheory/lockspire/commit/e61a1d10ff18fa34e6c3a5a067c630bd28383433))
* **30-01:** add device authorization schema and migrations ([255e712](https://github.com/szTheory/lockspire/commit/255e712da86068be7e1dc43c464709683ae2b8ca))
* **30-01:** implement device authorization domain and store behavior ([95de4c5](https://github.com/szTheory/lockspire/commit/95de4c5e8e008600448d9b167f9c87c1ce24d894))
* **30-01:** implement put_device_authorization repository behavior ([00ebdea](https://github.com/szTheory/lockspire/commit/00ebdea6889c3fa5369f7a3650f7b9894c234f02))
* **30-02:** implement device authorization protocol pipeline ([bbf1bb9](https://github.com/szTheory/lockspire/commit/bbf1bb9757478faa9ec853a90859d5297eb44948))
* **30-02:** implement device code generation utilities ([4167afc](https://github.com/szTheory/lockspire/commit/4167afc379ccc82c57d449523978a3e699be5ecd))
* **30-03:** add POST /device/code route ([e934422](https://github.com/szTheory/lockspire/commit/e934422d02fe856057cfd6af0e38bb2038a12349))
* **30-03:** implement device authorization controller and json view ([ae3a7c7](https://github.com/szTheory/lockspire/commit/ae3a7c70ee96bf54f741df28378894c451505d7f))
* **31-01:** extend device authorization verification state ([be80f25](https://github.com/szTheory/lockspire/commit/be80f2554981f79403c9a3eae42f5979359b8ca3))
* **31-01:** implement device authorization transitions ([2196724](https://github.com/szTheory/lockspire/commit/21967246f1121ea2b2145d6096afa530672b8209))
* **31-02:** generate host-owned verification seam ([7c97bac](https://github.com/szTheory/lockspire/commit/7c97bac40c548e98fe21559580b6925562717c1e))
* **31-02:** implement controller-first verification starter seam ([6421ee9](https://github.com/szTheory/lockspire/commit/6421ee98a45acc287973b4fccfc05517bc290626))
* **31-03:** add device verification host guide ([10383e8](https://github.com/szTheory/lockspire/commit/10383e8b7b81b2fbef589a9f6dca0b44c530eb07))
* **31-03:** wire phase 31 verification docs ([410dc36](https://github.com/szTheory/lockspire/commit/410dc36c6ed3a2cd7b6afe46c1d0130dbb7b6a60))
* **31-04:** add device verification protocol API ([211c385](https://github.com/szTheory/lockspire/commit/211c385ba2ffc57fb8860cff41f20b214d704b5a))
* **31-04:** emit verification uri complete responses ([1deed15](https://github.com/szTheory/lockspire/commit/1deed157e9c98ca1ab26a3b4ee8ebcb744f13ac0))
* **32-01:** add durable device polling state ([72a5dce](https://github.com/szTheory/lockspire/commit/72a5dce8495fa070bae705f7a6070450617a3547))
* **32-01:** implement durable device poll semantics ([cfbfc29](https://github.com/szTheory/lockspire/commit/cfbfc290c6bc58990770feadcf03f8e598c5de54))
* **32-02:** audit and finalize device token redemption ([8147ad8](https://github.com/szTheory/lockspire/commit/8147ad8fb56f667d11458198c1c2cfd74d56c626))
* **32-02:** route device grants through token exchange ([79f27c6](https://github.com/szTheory/lockspire/commit/79f27c637229b3540985542cd7867694cd05444f))
* **32-03:** publish device flow discovery and docs truth ([69f19e6](https://github.com/szTheory/lockspire/commit/69f19e66416cd7cb0705e83be5b4176b805ca482))
* **32-03:** publish device polling on token endpoint ([908530d](https://github.com/szTheory/lockspire/commit/908530db7f09a04ed069956d8b9e0394cc176371))
* **32-03:** wire device code issuance to host verification seam ([b452435](https://github.com/szTheory/lockspire/commit/b452435c26e940f87c7211c183ce46241702d388))
* **33-01:** implement DPoP proof validator and thumbprints ([40ffca8](https://github.com/szTheory/lockspire/commit/40ffca811e86e0f33905c138d310fef77efb4ab6))
* **33-01:** validate DPoP proof claims against request context ([af389e1](https://github.com/szTheory/lockspire/commit/af389e1c26b1917f8ad26c9a90b39290ff0a086c))
* **33-02:** add durable DPoP replay state model ([d76a978](https://github.com/szTheory/lockspire/commit/d76a97841f61d4d55479e6a8da13628ebb7a8ff8))
* **33-02:** enforce durable DPoP replay detection ([d64c555](https://github.com/szTheory/lockspire/commit/d64c55535b1dec7afad009883928731280b5a42c))
* **33-03:** persist explicit DPoP policy state ([6da9d84](https://github.com/szTheory/lockspire/commit/6da9d8440d78a1d339a8b07c96657ddee2cafb2c))
* **33-03:** resolve effective DPoP policy ([faee94e](https://github.com/szTheory/lockspire/commit/faee94efc2e93de3028e14254f4f39c3f43cccc8))
* **34-01:** add shared token-endpoint dpop context seam ([0df116e](https://github.com/szTheory/lockspire/commit/0df116e227ece14eaa499f3772e8b386ecd78919))
* **34-01:** issue truthful dpop-bound auth-code tokens ([5d010fd](https://github.com/szTheory/lockspire/commit/5d010fd220d6b53e9ca8946d8b5f0b536143411f))
* **34-02:** enforce atomic refresh binding persistence ([f7de7bc](https://github.com/szTheory/lockspire/commit/f7de7bc42aee4e848123b064c0b895aa825cf410))
* **34-02:** enforce refresh dpop binding semantics ([036c8f8](https://github.com/szTheory/lockspire/commit/036c8f82f6156e0292feadced64ddee4298aae6b))
* **34-03:** bind device redemption through shared dpop issuance ([f235d2d](https://github.com/szTheory/lockspire/commit/f235d2d63ab4c407925e15820f9f166d86d69081))
* **35-01:** add protected-resource dpop validation ([11dc70a](https://github.com/szTheory/lockspire/commit/11dc70a693ccceb0df55a298be736a84b56a81b6))
* **35-01:** enforce dpop binding on userinfo ([47177a3](https://github.com/szTheory/lockspire/commit/47177a3d06fb59704a3d9306fa793e3f0e1e1dcf))
* **35-02:** gate discovery dpop metadata on owned routes ([b0a1502](https://github.com/szTheory/lockspire/commit/b0a15020822d557d5a3fbc784345584047d7a76b))
* **35-02:** narrow public dpop support claims ([820e903](https://github.com/szTheory/lockspire/commit/820e9037297a23b16425e3fdfc36ea1a36a8ae9a))
* **35-03:** add admin DPoP policy controls ([2f61db1](https://github.com/szTheory/lockspire/commit/2f61db1c5f7354d19427260ef20e2c90b45eed09))
* **35-03:** wire DCR DPoP policy metadata ([7e0ff32](https://github.com/szTheory/lockspire/commit/7e0ff322756b2c8835e8c87fd285f8ff16eb2f24))
* **36-02:** expose durable cnf truth through introspection ([54429f6](https://github.com/szTheory/lockspire/commit/54429f634c7e610b61df5bf4453675465e5432c6))
* **37-01:** add protocol-owned auth_time to id tokens ([2b6a3ef](https://github.com/szTheory/lockspire/commit/2b6a3ef989eb70561280b5f5ee918ecb49a198a6))
* **37-01:** reserve auth_time in host claims ([a17c039](https://github.com/szTheory/lockspire/commit/a17c03962c10c9486703528e3b37335550dfd4f7))
* **37-02:** tighten authorize request parsing ([7794a02](https://github.com/szTheory/lockspire/commit/7794a02ffbac09f76030df85db0589e943870cb2))
* **37-03:** enforce silent auth and durable auth_time tokens ([174cee9](https://github.com/szTheory/lockspire/commit/174cee967033cfa5549d865e09a5625e9037b721))
* **37-03:** persist interaction auth_time metadata ([7e187e4](https://github.com/szTheory/lockspire/commit/7e187e4e2a1cb9be4f8d55b5a5b04a67b886d9d1))
* **37-04:** add phase 37 strictness proof lane ([63f767d](https://github.com/szTheory/lockspire/commit/63f767dce0a79b9cd5ab2aeb625dd178131e7660))
* **37-04:** capture phase 37 strictness proof artifacts ([4b6664c](https://github.com/szTheory/lockspire/commit/4b6664c4bde9786bf6b796d6a253f9df6814cca2))
* **37-04:** wire phase 37 conformance lanes ([5de2a24](https://github.com/szTheory/lockspire/commit/5de2a24393eab41c1a99d4f08c433ada1c96650b))
* **38-02:** add sid field to interactions/tokens with revoke_by_sid/1 ([bc60128](https://github.com/szTheory/lockspire/commit/bc601281f046920cf62b09a3da06a643953fef2c))
* **38-02:** thread sid through token issuance pipeline and emit in ID tokens ([7d779ad](https://github.com/szTheory/lockspire/commit/7d779adf058ee3daeacfc33501bf39c6bd628596))
* **39-02:** add typed client logout fields ([9d6d04e](https://github.com/szTheory/lockspire/commit/9d6d04ec3e8ba247d9f50e3e6041b52ff8f1c659))
* **39-02:** reject unsupported logout metadata in dcr ([8447d92](https://github.com/szTheory/lockspire/commit/8447d92122eed993b4d0560e88be08034804c212))
* **39-02:** validate logout propagation client settings ([e6d8d5b](https://github.com/szTheory/lockspire/commit/e6d8d5b740cfab2b55fa081caa84532efb388add))
* **39-03:** add durable logout event and delivery records ([d4e4f04](https://github.com/szTheory/lockspire/commit/d4e4f04b838c42a6769f4260cf998739573c143e))
* **39-03:** add logout event and delivery storage contracts ([676aaf7](https://github.com/szTheory/lockspire/commit/676aaf77b294759fd4957267ffc24329c8cac05b))
* **39-03:** persist logout propagation snapshots in the repository ([08db809](https://github.com/szTheory/lockspire/commit/08db8099ca9f94f4799d43f09d6f16249cf9b633))
* **39-04:** add logout lifecycle telemetry and audit ([d97c437](https://github.com/szTheory/lockspire/commit/d97c4371185ae80074ac137f65b8d56764fdcfbe))
* **39-04:** implement logout token delivery worker ([b872e7f](https://github.com/szTheory/lockspire/commit/b872e7f32491dd1530b59eab17ef2a4bf0444e87))
