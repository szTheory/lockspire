defmodule Lockspire.Web.TestHostRouter do
  @moduledoc false
  ...
  # Test-only host mount that mirrors Lockspire.Web.AdminRouter under /admin.
  # Route-truth tests still inspect AdminRouter; this endpoint exists so
  # LiveViewTest exercises the host-mounted paths without exposing admin routes
  # from the public OAuth/OIDC router.
  scope "/admin" do
...
defmodule Lockspire.Web.Endpoint do
  ...
  plug(Lockspire.Web.TestHostRouter)
end
