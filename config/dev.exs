...
config :lockspire, Lockspire.TestRepo,
  username: System.get_env("LOCKSPIRE_DB_USER") || System.get_env("PGUSER") || System.get_env("USER"),
  ...
  port: String.to_integer(System.get_env("LOCKSPIRE_DB_PORT") || System.get_env("PGPORT") || "5432"),
