defmodule Lockspire.TestRepo.Migrations.CreateLockspireCoreTables do
  ...
  def change do
    ensure_lockspire_schema()

    create lockspire_table(:lockspire_clients) do
    ...
    create(lockspire_unique_index(:lockspire_clients, [:client_id]))

    create lockspire_table(:lockspire_interactions) do
    ...
    create(lockspire_unique_index(:lockspire_interactions, [:interaction_id]))
    create(lockspire_index(:lockspire_interactions, [:client_id]))
    create(lockspire_index(:lockspire_interactions, [:expires_at]))

    create lockspire_table(:lockspire_consent_grants) do
    ...
    create(lockspire_index(:lockspire_consent_grants, [:account_id]))
    create(lockspire_index(:lockspire_consent_grants, [:client_id]))

    create lockspire_table(:lockspire_tokens) do
    ...
    create(lockspire_unique_index(:lockspire_tokens, [:token_hash]))
    create(lockspire_index(:lockspire_tokens, [:family_id]))
    create(lockspire_index(:lockspire_tokens, [:client_id]))

    create lockspire_table(:lockspire_signing_keys) do
    ...
    create(lockspire_unique_index(:lockspire_signing_keys, [:kid]))
    create(lockspire_index(:lockspire_signing_keys, [:status]))
  end
end
